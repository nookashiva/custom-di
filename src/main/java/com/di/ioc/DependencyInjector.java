...
public class DependencyInjector {
    ...
    public static DependencyContainer run(Class<?> startupClass) {
        return run(startupClass, new DependencyConfiguration());
    }
     ...
     */
    public static DependencyContainer run(Class<?> startupClass, DependencyConfiguration configuration) {
    ...
    public static DependencyContainer run(File[] startupDirectories, DependencyConfiguration configuration) {
